...
def main():
    ...
    """
    subfolder = "SPX"
    filtered_path = "data/" +subfolder+ "/put/checks_pd.parquet"
    final_path    = "data/" +subfolder+ "/put/filtered_pd.parquet"
    checks_path   = "data/" +subfolder+ "/put/checks/all_pd.parquet"
